...
@registerRule("IsaacComposition")
@register_requirements(IsaacCompositionCapReqs.ISA_001, override=True)
class IsaacCompositionCapabilityChecker(BaseRuleChecker):
