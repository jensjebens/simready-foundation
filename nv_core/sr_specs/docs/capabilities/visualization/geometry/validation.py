...
@registerRule("Geometry")
@register_requirements(cap.GeometryRequirements.VG_001, override=True)
class ImageableGeometryChecker(BaseRuleChecker):
...
@registerRule("Geometry")
@register_requirements(cap.GeometryRequirements.VG_002, override=True)
class UsdGeomExtentChecker(BaseRuleChecker):
...
# @registerRule("Geometry")
# @register_requirements(cap.GeometryRequirements.VG_012, override=True)
# class UsdGeomMeshSmallChecker(BaseRuleChecker):
...
@registerRule("Geometry")
@register_requirements(cap.GeometryRequirements.VG_023, override=True)
class MeshXformPositioningChecker(BaseRuleChecker):
...
@registerRule("Geometry")
@register_requirements(cap.GeometryRequirements.VG_025, override=True)
...
@registerRule("Geometry")
@register_requirements(cap.GeometryRequirements.VG_026, override=True)
class AssetPivotPlacementChecker(BaseRuleChecker):
...
class NormalsShouldBeCorrectChecker(BaseRuleChecker):
    """
...
@registerRule("Geometry")
@register_requirements(cap.GeometryRequirements.VG_014, override=True)
...
@registerRule("Geometry")
@register_requirements(cap.GeometryRequirements.VG_MESH_001, override=True)
class GeomShallBeMeshChecker(BaseRuleChecker):
    """
...
@registerRule("Geometry")
@register_requirements(cap.GeometryRequirements.VG_027, override=True)
