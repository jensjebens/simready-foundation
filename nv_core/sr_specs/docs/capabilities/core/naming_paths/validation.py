...
@registerRule("NamingPaths")
@register_requirements(cap.NamingPathsRequirements.NP_001, override=True)
class PrimNamingConventionChecker(BaseRuleChecker):
...
@registerRule("NamingPaths")
@register_requirements(cap.NamingPathsRequirements.NP_002, override=True)
class FileNamingConventionChecker(BaseRuleChecker):
...
@registerRule("NamingPaths")
@register_requirements(cap.NamingPathsRequirements.NP_003, override=True)
class DirectoryStructureChecker(BaseRuleChecker):
...
@registerRule("NamingPaths")
@register_requirements(cap.NamingPathsRequirements.NP_004, override=True)
class PathLengthLimitsChecker(BaseRuleChecker):
...
@registerRule("NamingPaths")
@register_requirements(cap.NamingPathsRequirements.NP_005, override=True)
class AssetFolderStructureChecker(BaseRuleChecker):
...
@registerRule("NamingPaths")
@register_requirements(cap.NamingPathsRequirements.NP_006, override=True)
class MetadataLocationChecker(BaseRuleChecker):
...
@registerRule("NamingPaths")
@register_requirements(cap.NamingPathsRequirements.NP_007, override=True)
class RelativePathsChecker(BaseRuleChecker):
...
@registerRule("NamingPaths")
@register_requirements(cap.NamingPathsRequirements.NP_008, override=True)
class PathsExistChecker(BaseRuleChecker):
    """
