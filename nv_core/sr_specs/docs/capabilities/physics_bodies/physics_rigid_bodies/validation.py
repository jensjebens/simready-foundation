...
@registerRule("PhysicsRigidBodies")
@register_requirements(cap.PhysicsRigidBodiesRequirements.RB_001, override=True)
class RigidBodyCapabilityChecker(BaseRuleChecker):
...
@registerRule("PhysicsRigidBodies")
@register_requirements(cap.PhysicsRigidBodiesRequirements.RB_007, override=True)
class RigidBodyMassChecker(BaseRuleChecker):
...
@registerRule("PhysicsRigidBodies")
@register_requirements(cap.PhysicsRigidBodiesRequirements.RB_COL_001, override=True)
class RigidBodyColliderCapabilityChecker(BaseRuleChecker):
...
@registerRule("PhysicsRigidBodies")
@register_requirements(PhysxRigidBodyColliderReqs.PHYSX_COL_001, override=True)
class PhysxRigidBodyColliderCapabilityChecker(BaseRuleChecker):
...
@registerRule("PhysicsRigidBodies")
@register_requirements(cap.PhysicsRigidBodiesRequirements.RB_COL_002, override=True)
class RigidBodyColliderMeshChecker(BaseRuleChecker):
    def CheckPrim(self, prim: Usd.Prim) -> None:
...
@registerRule("PhysicsRigidBodies")
@register_requirements(cap.PhysicsRigidBodiesRequirements.PHYSX_COL_002, override=True)
class PhysxRigidBodyColliderMeshChecker(BaseRuleChecker):
    def CheckPrim(self, prim: Usd.Prim) -> None:
...
@registerRule("PhysicsRigidBodies")
@register_requirements(cap.PhysicsRigidBodiesRequirements.RB_COL_003, override=True)
class RigidBodyColliderNonUniformScaleChecker(BaseRuleChecker):
...
@registerRule("PhysicsRigidBodies")
@register_requirements(cap.PhysicsRigidBodiesRequirements.RB_COL_004, override=True)
...
@registerRule("PhysicsRigidBodies")
@register_requirements(cap.PhysicsRigidBodiesRequirements.RB_010, override=True)
class InvisibleCollisionMeshHasPurposeGuide(BaseRuleChecker):
...
@registerRule("PhysicsRigidBodies")
@register_requirements(MultibodyReqs.RB_MB_001, override=True)
class MultibodyChecker(BaseRuleChecker):
    def CheckStage(self, stage: Usd.Stage) -> None:
        default_prim = stage.GetDefaultPrim()
        if not default_prim:
            self._AddFailedCheck("Stage has no default prim. Unable to validate.", at=stage)
...
@registerRule("PhysicsRigidBodies")
@register_requirements(cap.PhysicsRigidBodiesRequirements.RB_011, override=True)
class NestedRigidBodyMassChecker(BaseRuleChecker):
    def has_mass(self, prim: Usd.Prim) -> bool:
        return prim.HasAPI(UsdPhysics.MassAPI) and prim.GetAttribute("physics:mass").Get() is not None
...
@registerRule("PhysicsRigidBodies")
@register_requirements(cap.PhysicsRigidBodiesRequirements.RB_012, override=True)
class NoNestedRigidBodyWithoutJointChecker(BaseRuleChecker):
